		...
		<div class="content">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-10 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-1">
					...
					<p class="font-size-19">O <b>Registro Livre</b> é um projeto sem fins lucrativos, defensor da liberdade de informação 
					...
					<p class="font-size-19">Se você tem contratos sociais de empresas brasileiras para compartilhar conosco, faça o upload 
					...
					<p class="font-size-19">Os repórteres são o público-alvo principal do Registro Livre, porque no desempenho de suas 
					...
					<p class="font-size-19">Assim como os jornalistas, advogados, contadores, administradores e outros profissionais da área 
					...
					<p class="font-size-19">O Registro Livre é um projeto de software livre. Portanto, você pode obter nosso código-fonte no 
					...
					<p class="font-size-19">Os contratos sociais são documentos públicos. Obter informações sobre a finalidade e estrutura 
