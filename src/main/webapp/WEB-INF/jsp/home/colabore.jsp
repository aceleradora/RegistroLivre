		...
		<div class="content">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-10 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-1">
					...
					<p class="text-justify font-size-19">O <b>Registro Livre</b> é um projeto sem fins lucrativos, defensor da liberdade de informação 
					...
					<p class="text-justify font-size-19">Se você tem contratos sociais de empresas brasileiras para compartilhar conosco, faça o upload 
					em nosso banco de dados, ou então os envie para o email contato@registrolivre.inf.br.</br>
					
					<h1 class="centralize font-size-40 title"> Jornalistas</h1>
					
					<p class="text-justify font-size-19">Os repórteres são o público-alvo principal do Registro Livre, porque no desempenho de suas 
					...
					<h2 class="centralize font-size-30 title"> Advogados, contadores, administradores e outros profissionais da área comercial. </h2>
					<p class="text-justify font-size-19">Assim como os jornalistas, advogados, contadores, administradores e outros profissionais da área 
					...
					<h1 class="centralize font-size-40 title"> Todos os cidadãos</h1>
					<p class="text-justify font-size-19">Os contratos sociais são documentos públicos. Obter informações sobre a finalidade e estrutura 
					...
					<ul>
						...
						<li>Divulgue o Registro Livre em redes sociais como <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://registro-livre-staging.herokuapp.com/" data-lang="pt" data-count="none" data-hashtags="registrolivre" data-dnt="true">Tweetar</a>
 e <div class="fb-share-button" data-href="http://registro-livre-staging.herokuapp.com/" data-layout="button"></div></li>
					</ul>					
				</div>
			</div>
