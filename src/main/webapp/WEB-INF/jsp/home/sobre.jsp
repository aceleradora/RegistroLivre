...
<html lang="pt-br">
<head>
	<title>Registro Livre - Sobre</title>
		...
		<div class="content">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-10 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-1">
					...
					<h1 class="centralize title"> Quem Somos</h1>
					

					<p class="text">O <b>Registro Livre</b> é uma plataforma de dados abertos cujo objetivo principal é colocar à
